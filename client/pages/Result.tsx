  ...
  if (!payload) {
    return (
      <div className="w-full flex justify-center">
        <section
          className={cn(
            "w-[95%] sm:max-w-md rounded-[14px] p-6 bg-white shadow-[0_4px_12px_rgba(0,0,0,0.05)] border border-slate-100",
          )}
        >
          <div className="text-center">
            <div className="text-lg font-semibold">Нет данных для показа</div>
            <div className="mt-4 text-sm text-slate-500">
              Вернитесь на главную, чтобы провести расчёт.
            </div>
            <div className="mt-4">
        ...
        <div className="space-y-4">
          <div>
            ...
            <p className="text-sm text-slate-500">
              Сервис: {payload.servicePercent}% · Всего:{" "}
                  ...
                  <div key={d.id} className="space-y-1">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-xs text-slate-500">
                        {d.totalPrice.toLocaleString(undefined, {
                          minimumFractionDigits: 2,
                          maximumFractionDigits: 2,
                        })}{" "}
                        UZS
